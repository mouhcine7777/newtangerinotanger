  ...
  const menuSections: MenuSection[] = [
    {
      ...
      items: [
        {
          name: "CASSOLETTE DE CHAMPIGNONS À L'AIL",
          price: "70",
          description: "Champignons sautés à l'ail parfumé",
          detailedDescription: "Champignons frais mijotés avec de l'ail doré, servis en cassolette chaude"
        },
        {
          name: "CASSOLETTE DE VIANDE HACHÉE FAÇON « TAJINE »",
          price: "90",
          description: "Viande épicée à la marocaine",
          detailedDescription: "Viande hachée mijotée aux épices traditionnelles du tajine"
        },
        {
          name: "CREVETTES À L'AIL",
          price: "120",
          description: "Crevettes, ail, huile d'olive",
          detailedDescription: "Crevettes fraîches sautées dans une huile d'olive parfumée à l'ail"
        },
        {
          name: "CASSOLETTE DE PALOURDES",
          price: "120",
          description: "Coquillages mijotés",
          detailedDescription: "Palourdes fraîches cuites dans leur jus savoureux"
        },
        {
          name: "CASSOLETTE DE CALAMARS ET SAUCE TOMATE FAÇON « TAJINE »",
          price: "160",
          description: "Calamars en sauce épicée",
          detailedDescription: "Calamars tendres mijotés dans une sauce tomate parfumée aux épices du tajine"
        },
        {
          name: "ESPADON ET CREVETTES FAÇON « RIGAMONTI »",
          price: "180",
          description: "Duo de poisson et crustacés",
          detailedDescription: "Espadon et crevettes préparés selon notre recette signature Rigamonti"
        },
        {
          name: "POULPE, CREVETTES, ET POMMES DE TERRE À L'AIL",
          price: "180",
          description: "Trio de fruits de mer parfumé",
          detailedDescription: "Mélange généreux de poulpe tendre, crevettes et pommes de terre relevés à l'ail"
        },
        {
          name: "MERLU, CREVETTES ET PALOURDES AUX OIGNONS",
          price: "180",
          description: "Assortiment de la mer aux oignons",
          detailedDescription: "Poisson merlu et fruits de mer mijotés avec des oignons fondants"
        },
        {
          name: "POMMES DE TERRE AUX CREVETTES ET CALAMARS À LA SAUCE TOMATE",
          price: "180",
          description: "Ragoût de fruits de mer méditerranéen",
          detailedDescription: "Pommes de terre mijotées avec crevettes et calamars dans une riche sauce tomate"
        }
      ]
    }
  ];
