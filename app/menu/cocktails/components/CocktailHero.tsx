  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
Découvrez nos créations mixologiques uniques, élaborées par notre équipe de barmen passionnés avec des spiritueux d'exception et des ingrédients raffinés.
        </motion.p>
