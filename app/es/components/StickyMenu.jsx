...
const menuItems = [
  { id: 'cocktails', label: 'Cócteles & Refrescos', link: '/es/menu/cocktails' },
  { id: 'champagne', label: 'Champán y Vinos', link: '/es/menu/champagne' },
  { id: 'bieres', label: 'Cervezas & Licores', link: '/es/menu/beers' },
  { id: 'tapas', label: 'Tapas & Entrantes', link: '/es/menu/tapas' },
  { id: 'Spécialités de la maison', label: 'Especialidades de la casa', link: '/es/menu/specialites-de-la-maison' },
  { id: 'cassolettes', label: 'Cazuelitas', link: '/es/menu/cassolettes' },
  { id: 'poissons', label: 'Pescados & Carnes', link: '/es/menu/poissons' },
  { id: 'Tortillas & Fritures', label: 'Tortillas & Frituras', link: '/es/menu/tortillas' },
  { id: 'De Rome à New York', label: 'De Roma a Nueva York', link: '/es/menu/rome-newyork' },
