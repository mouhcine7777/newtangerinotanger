...
export default function MenuCategorySection() {
  ...
  // Menu categories data - Spanish version
  const menuCategories: MenuCategory[] = [
    {
      id: 1,
      title: "Cócteles y Bebidas",
      description: "Cócteles refinados y bebidas sin alcohol",
      image: "/cocktails.jpg",
      slug: "cocktails"
    },
    {
      ...
      description: "Selección premium de champanes y vinos finos",
      image: "/champagne.jpg",
      slug: "champagne"
    },
    {
      ...
      description: "Cervezas artesanales y bebidas frescas",
      image: "/beer.jpg",
      slug: "beers"
    },
    {
      ...
      description: "Deliciosos entrantes y tapas para compartir",
      image: "/tapas.jpg",
      slug: "tapas"
    },
    {
      ...
      description: "Saborea nuestras tortillas artesanales y frituras doradas a la perfección",
      image: "/tortillas.jpg",
      slug: "tortillas"
    },
    {
      id: 6,
      title: "Cazuelas",
      description: "Platos guisados tradicionales servidos en cazuela",
    ...
    },
    {
      ...
      description: "Nuestras creaciones exclusivas y platos emblemáticos",
      image: "/specialites.jpg",
      slug: "specialites-de-la-maison"
    },
    {
      id: 8,
      title: "Pescado y Carne",
      description: "Selección premium de pescados frescos y carnes nobles",
      image: "/poisson.jpg",
      slug: "poissons"
    },
    {
      id: 9,
      title: "De Roma a Nueva York",
      description: "Dos mundos, una pasión común",
    ...
    },
    {
      id: 10,
      title: "Postres",
      description: "Creaciones dulces para terminar con estilo",
      image: "/desserts.jpg",
      slug: "desserts"
    }
  ];
  ...
  return (
    <section id="menu" ref={menuRef} className="py-20 bg-[#3e4c52] text-amber-50 relative">
      ...
      >
        <h2 className="font-SweetSansProBold text-4xl md:text-5xl font-serif tracking-wider text-amber-50 mb-4">LA CARTA</h2>
        <p className="text-amber-100/70 font-light max-w-2xl mx-auto">
          Descubre nuestras creaciones culinarias, donde cada plato cuenta una historia de pasión y maestría.
        </p>
      </motion.div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {menuCategories.map((category, index) => (
            <Link key={category.id} href={`/es/menu/${category.slug}`} className="block">
              <motion.div
