...
export default function BieresMenu() {
  ...
  const sangria: SimpleItem[] = [
    { name: 'Sangría Jarra', price: '440' }
  ];

  // Datos de Aperitivos
  const aperitifs: SimpleItem[] = [
    { name: 'Pastis', price: '70' },
    { name: 'Oporto Offley Tinto', price: '70' },
    { name: 'Oporto Offley Blanco', price: '70' },
    { name: 'Martini Rojo', price: '70' },
    { name: 'Martini Blanco', price: '80' },
    { name: 'Martini Rosado', price: '80' },
  ...
  const rhum: SimpleItem[] = [
    { name: 'Bacardi Blanco', price: '100' },
    { name: 'Bacardi Oro', price: '100' },
  ...
  const whisky: SpiritItem[] = [
    ...
    { name: 'Dewar\'s 12 Años', glass: '100', bottle: '-' },
    { name: 'Dewar\'s 15 Años', glass: '120', bottle: '-' },
    { name: 'Dewar\'s 18 Años', glass: '150', bottle: '-' },
    { name: 'Glenfiddich 12 Años', glass: '120', bottle: '-' },
    { name: 'Glenfiddich 15 Años', glass: '140', bottle: '-' },
    { name: 'Glenfiddich 18 Años', glass: '160', bottle: '-' },
  ...
  const tequila: SpiritItem[] = [
    ...
    { name: 'Patron Añejo', glass: '300', bottle: '3000' }
  ];
  ...
  // Componente de sección simple (nombre + precio)
  ...
  // Sección de tabla de licores (nombre + copa + botella)
  ...
  return (
    <section ref={menuRef} className="py-16 bg-[#3e4c52] text-amber-50 relative">
      ...
      <div className="container mx-auto px-4">
        {/* SECCIÓN DE CERVEZAS Y SANGRÍA */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
          <SimpleSection title="CERVEZAS" items={bieres} />
          <SimpleSection title="SANGRÍA" items={sangria} />
        </div>

        <SmallDivider />

        {/* SECCIÓN DE APERITIVOS Y DIGESTIVOS */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
          <SimpleSection title="APERITIVOS" items={aperitifs} />
          <SimpleSection title="DIGESTIVOS" items={digestifs} />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
          <SimpleSection title="COÑAC / BRANDY" items={cognacBrandy} />
          <SimpleSection title="RON" items={rhum} />
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <SpiritTableSection title="GINEBRA" items={gin} />
