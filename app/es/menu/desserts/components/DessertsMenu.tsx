  ...
  const menuSections: MenuSection[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: 80,
          description: "Frescura natural y colorida",
          detailedDescription: "Selección de frutas frescas de temporada para un final ligero y vitamínico"
        },
        {
          name: "TIRAMISÚ",
          price: 80,
          description: "Dulzura italiana al café",
          detailedDescription: "El gran clásico italiano, delicadas capas de mascarpone y bizcochos empapados"
        },
        {
          name: "TURRÓN HELADO",
          price: 80,
          description: "Frescura provenzal helada",
        ...
        },
        {
          ...
          price: 80,
          description: "Creación signature de la casa",
