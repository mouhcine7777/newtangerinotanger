      ...
      items: [
        {
          ...
          price: "120",
          description: "Hamburguesa clásica a la americana",
          detailedDescription: "El clásico atemporal revisitado con cuidado, generoso y sabroso"
        },
        {
          name: "HAMBURGUESA CON CAMEMBERT FRITO",
          price: "140",
          description: "Hamburguesa gourmet con queso caliente",
          detailedDescription: "Una fusión audaz entre tradición americana y refinamiento francés"
        },
        {
          name: "HAMBURGUESA DE POLLO",
          price: "140",
          description: "Hamburguesa tierna de pollo",
          detailedDescription: "Alternativa ligera y sabrosa para los amantes del pollo"
        }
      ]
    },
    {
      ...
      items: [
        {
          name: "PIZZA DE QUESO",
          price: "80",
          description: "Pizza Margarita clásica",
          detailedDescription: "La simplicidad en su máxima expresión, celebrando la pureza de los sabores italianos"
        },
        {
          name: "PIZZA VEGETARIANA",
          price: "80",
          description: "Pizza con verduras de temporada",
        ...
        },
        {
          ...
          price: "120",
          description: "Pizza generosa del mar",
          detailedDescription: "Los tesoros del océano encuentran la tradición napolitana"
        }
      ]
    },
    {
      title: 'PASTAS Y RISOTTOS',
      items: [
        {
          name: "RISOTTO DE CHAMPIÑONES",
          price: "120",
          description: "Arroz cremoso con champiñones",
          detailedDescription: "Cremosidad perfecta y sabores del bosque en este gran clásico italiano"
        },
        {
          name: "RISOTTO DE MARISCOS",
          price: "140",
          description: "Risotto con sabores marinos",
          detailedDescription: "La cremosidad del arroz encuentra la frescura del océano en una danza delicada"
        },
        {
          name: "PASTA DE MARISCOS",
          price: "180",
          description: "Pasta generosa del mar",
          detailedDescription: "Generosidad marina sublimada por una preparación cuidadosa y auténtica"
        }
      ]
    }
  ];
