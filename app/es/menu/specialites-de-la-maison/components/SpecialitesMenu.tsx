      ...
      items: [
        {
          ...
          price: "320",
          portion: "2 pers",
          description: "Paella con verduras de temporada",
        ...
        },
        {
          ...
          detailedDescription: "Arroz bomba teñido con tinta de sepia, con gambas frescas y alcachofas tiernas"
        },
        {
          name: "FIDEUÁ DE MARISCOS",
          price: "380",
          portion: "2 pers",
          description: "Paella de fideos con mariscos",
          detailedDescription: "Variación tradicional catalana de la paella, preparada con fideos finos y mariscos"
        },
        {
          name: "PAELLA DE PESCADOS Y MARISCOS",
          price: "380",
          portion: "2 pers",
          description: "Paella generosa del mar",
          detailedDescription: "Paella rica en pescados frescos y mariscos variados sobre arroz azafranado"
        },
        {
          name: "PAELLA MIXTA",
          price: "400",
          portion: "2 pers",
          description: "Paella de carnes y mariscos",
          detailedDescription: "Paella completa que combina carnes tiernas y mariscos en una armonía de sabores"
        },
        {
          name: "PESCADOS Y MARISCOS DEL DÍA AL HORNO ESTILO TAJINE",
          price: "1400",
          description: "Selección de pescados y mariscos al horno",
          detailedDescription: "Preparación excepcional de pescados y mariscos frescos del día, cocidos a fuego lento con especias orientales según la tradición del tajine"
        }
      ]
    }
  ];
