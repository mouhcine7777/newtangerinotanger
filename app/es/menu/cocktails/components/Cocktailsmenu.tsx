...
export default function CocktailsMenu() {
  ...
  const cocktails: CocktailItem[] = [
    {
      name: "SUMMER BREEZE",
      price: "160",
      ingredients: "Vodka Russian Standard, Sandía Fresca",
      description: "Refrescante cóctel de verano con la frescura de la sandía"
    },
    {
      name: "LEMONICA LEWHISKY",
      price: "160",
      ingredients: "Whisky Grants, Amareto di Saronno, Limón, Jarabe de Manzana Verde, Pimienta Negra",
      description: "Una creación audaz que mezcla whisky, amaretto y pimienta negra"
    },
    {
      name: "TSAR WARS",
      price: "160",
      ingredients: "Vodka Russian, Jarabe de Caña, Limón, Fresa",
      description: "Un cóctel real con notas de fresa y limón"
    },
    {
      name: "GIN SLIM",
      price: "160",
      ingredients: "Gin Seco Bombay, Martini Bianco, Lychee, Menta",
      description: "Elegante mezcla de gin, lichi y menta fresca"
    },
    {
      name: "RUMINTIC",
      price: "160",
      ingredients: "Bacardi Gold, Piña, Licor de Cacao Blanco, Jarabe de Caramelo, Menta",
      description: "Cóctel tropical con sabores de piña y cacao"
    },
    {
      name: "BASILIC INSTINCT",
      price: "160",
      ingredients: "Jack Daniel Honey, Aperol, Jarabe de Jengibre, Albahaca, Martini Dry, Limón",
      description: "Cóctel aromático con albahaca fresca y miel de Jack Daniel's"
    },
    {
      name: "BOUSSA NOVA",
      price: "160",
      ingredients: "Cachaça, Jarabe de Caña, Cordial de Lima, Fruta de la Pasión, Licor de Cassis",
      description: "Inspiración brasileña con frutas de la pasión"
    },
    {
      name: "T'ES QUI LÀ ?",
      price: "160",
      ingredients: "Tequila Camino, Licor de Frambuesa, Cordial de Lima, Jarabe de Caña",
      description: "Cóctel misterioso con sabores de frambuesa y lima"
    }
  ];
  ...
  const softs: SoftSection[] = [
    {
      category: "AGUAS MINERALES 75CL",
      items: [
        { name: "Ain Saiss", price: "50" },
        { name: "Oulmés", price: "50" },
        { name: "Evian", price: "90" },
        { name: "Evian Con Gas", price: "90" }
      ]
    },
    {
      category: "BEBIDAS",
      items: [
        { name: "Refresco", price: "50" },
        { name: "Zumo Fresco", price: "90" },
