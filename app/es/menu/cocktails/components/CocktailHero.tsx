  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
Descubre nuestras creaciones mixológicas únicas, elaboradas por nuestro equipo de bartenders apasionados con espíritus excepcionales e ingredientes refinados.
        </motion.p>
