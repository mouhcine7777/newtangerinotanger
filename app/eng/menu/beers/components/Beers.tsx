...
export default function BeersMenu() {
  ...
  const digestifs: SimpleItem[] = [
    ...
    { name: 'Plum Eau de Vie', price: '90' },
    { name: 'Poire Williams Eau de Vie', price: '90' }
  ];
  ...
  // Rum data
  const rum: SimpleItem[] = [
    { name: 'Bacardi White', price: '100' },
  ...
  return (
    <section ref={menuRef} className="py-16 bg-[#3e4c52] text-amber-50 relative">
      ...
      <div className="container mx-auto px-4">
        {/* BEERS & SANGRIA SECTION */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
          <SimpleSection title="BEERS" items={beers} />
          <SimpleSection title="SANGRIA" items={sangria} />
        </div>

        <SmallDivider />

        {/* APERITIFS & DIGESTIFS SECTION */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
          <SimpleSection title="APERITIFS" items={aperitifs} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
          ...
          <SimpleSection title="RUM" items={rum} />
        </div>
