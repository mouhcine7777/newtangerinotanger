  ...
  const menuSections: MenuSection[] = [
    {
      ...
      items: [
        {
          name: "GARLIC MUSHROOM CASSEROLE",
          price: "70",
          description: "Mushrooms sautéed with fragrant garlic",
          detailedDescription: "Fresh mushrooms simmered with golden garlic, served in a hot casserole"
        },
        {
          name: "GROUND MEAT CASSEROLE TAJINE-STYLE",
          price: "90",
          description: "Moroccan-spiced meat",
          detailedDescription: "Ground meat simmered with traditional tajine spices"
        },
        {
          name: "GARLIC SHRIMP",
          price: "120",
          description: "Shrimp, garlic, olive oil",
          detailedDescription: "Fresh shrimp sautéed in garlic-infused olive oil"
        },
        {
          name: "CLAM CASSEROLE",
          price: "120",
          description: "Simmered shellfish",
          detailedDescription: "Fresh clams cooked in their flavorful juices"
        },
        {
          name: "SQUID CASSEROLE WITH TOMATO SAUCE TAJINE-STYLE",
          price: "160",
          description: "Squid in spiced sauce",
          detailedDescription: "Tender squid simmered in a tomato sauce flavored with tajine spices"
        },
        {
          name: "SWORDFISH AND SHRIMP RIGAMONTI-STYLE",
          price: "180",
          description: "Fish and shellfish duo",
          detailedDescription: "Swordfish and shrimp prepared according to our signature Rigamonti recipe"
        },
        {
          name: "OCTOPUS, SHRIMP, AND POTATOES WITH GARLIC",
          price: "180",
          description: "Fragrant seafood trio",
          detailedDescription: "Generous mix of tender octopus, shrimp and potatoes enhanced with garlic"
        },
        {
          name: "HAKE, SHRIMP AND CLAMS WITH ONIONS",
          price: "180",
          description: "Seafood medley with onions",
          detailedDescription: "Hake fish and seafood simmered with melting onions"
        },
        {
          name: "POTATOES WITH SHRIMP AND SQUID IN TOMATO SAUCE",
          price: "180",
          description: "Mediterranean seafood stew",
          detailedDescription: "Potatoes simmered with shrimp and squid in a rich tomato sauce"
        }
      ]
    }
  ];
