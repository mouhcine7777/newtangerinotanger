...
const menuItems = [
  ...
  { id: 'Spécialités de la maison', label: 'House Specialties', link: '/eng/menu/specialites-de-la-maison' },
  { id: 'cassolettes', label: 'Casseroles', link: '/eng/menu/cassolettes' },
  { id: 'poissons', label: 'Fish & Meats', link: '/eng/menu/poissons' },
  { id: 'Tortillas & Fritures', label: 'Tortillas & Fried Foods', link: '/eng/menu/tortillas' },
  { id: 'De Rome à New York', label: 'From Rome to New York', link: '/eng/menu/rome-newyork' },
